...
usersRouter.get("/api/v1/users/public-profile/:courseId", usersCtrl.publicProfile);
usersRouter.get("/api/v1/users/private-profile/", isAuthenticated, isAdmin, usersCtrl.privateProfile);
